 ...
 */
package javaeetutorial.mailconnector.web.managedbeans;
...
public class MailBrowserBean implements Serializable {
    ...
    static final Logger logger =
            Logger.getLogger("mailconnector.web.managedbeans");
    ...
    public JavaMailConnection getConnection() {
        ...
        try {
            ...
            if (connectionFactory != null) {
                ...
                logger.info("MailBrowserBean.getConnection: " 
            ...
            logger.log(Level.SEVERE, "MailBrowserBean.getConnection: {0}",
                    e.getMessage());
            e.printStackTrace();
        }
        return connection;
    ...
    public String getUser() {
        ...
        try {
            ...
            logger.log(Level.SEVERE, " getUser: {0}", e.getMessage());
        }
    ...
    public HttpServletRequest getRequest() {
        ...
        try {
            ...
            logger.log(Level.SEVERE, " getRequest: {0}", e.getMessage());
        }
        return request;
    }
    ...
    public String retrieveMessages() {
        ...
        try {
            ...
            if (connectionAvailable) {
                ...
                if (messages != null) {
                    ...
                    for (short i = 0; i < messages.length; i++) {
                        ...
                        Address[] recipients =
                                (Address[]) messages[i].getAllRecipients();
            ...
            logger.log(Level.SEVERE, "MailBrowserBean.retrieveMessages: {0}",
                    e.toString());
        }
        return ("mailfolder");
    }
    ...
    public String logout() {
        ...
        try {
            ...
            logger.log(Level.SEVERE, "logout failed: {0}", e.toString());
        }
        return "login";
    }
}
