...
public class SendMailBean implements Serializable {
    ...
    static final Logger logger =
            Logger.getLogger("mailconnector.web.managedbeans.SendMailBean");
    ...
    public String getUser() {
        ...
        try {
            ...
            logger.log(Level.SEVERE, " retrieveUser: {0}", e.toString());
        }
    ...
    public HttpServletRequest getRequest() {
        ...
        try {
            ...
            logger.log(Level.SEVERE, " getRequest: {0}", e.toString());
        }
        return request;
    }
    ...
    public String sendMessage() {
        try {
            ...
            InternetAddress dests[] =
                    new InternetAddress[]{new InternetAddress(recipient + "@" + server)};
            ...
            logger.log(Level.SEVERE, "sendMessage failed: {0}", e.toString());
