...
public class ConnectionRequestInfoImpl implements ConnectionRequestInfo {
    ...
    public String getUserName() {
        logger.info("[Outbound:ConnectionRequestInfoImpl]: Calling getUserName");
        return userName;
    }
    ...
    public String getPassword() {
        logger.info("[Outbound:ConnectionRequestInfoImpl]: Calling getPassword");
        return password;
    }
    ...
    public String getServerName() {
        logger.info("[Outbound:ConnectionRequestInfoImpl]: Calling getServerName");
        return serverName;
    }
    ...
    public String getFolderName() {
        logger.info("[Outbound:ConnectionRequestInfoImpl]: Calling getFolderName");
        return folderName;
    }
    ...
    public String getProtocol() {
        logger.info("[Outbound:ConnectionRequestInfoImpl]: Calling getProtocol");
        return protocol;
    }
