...
public class EndpointConsumer {
    ...
    public EndpointConsumer(MessageEndpointFactory endpointFactory,
        ...
        logger.log(Level.INFO, "[EndpointConsumer] Created EndpointConsumer for: {0}",
                getUniqueKey());
    }
    ...
    public void deliverMessage(Message message)
        ...
        try {
            ...
            logger.log(Level.WARNING, "[Inbound:EndpointConsumer] deliverMessage.onmessageexception",
                    e.getMessage());
        } catch (Error error) {
            logger.log(Level.WARNING, "[Inbound:EndpointConsumer] deliverMessage.onmessageexception",
                    error.getMessage());
    ...
    public boolean hasNewMessages()
            throws Exception {
        logger.log(Level.INFO, "[Inbound:EndpointConsumer] Checking for new messages on: {0}",
                getUniqueKey());
    ...
    public Message[] getNewMessages() {
        ...
        try {
            ...
            logger.severe("[InboundEndpointConsumer] getNewMessages caught an exception. Bailing out");
        }
        return msgs;
