 ...
 */
package javaeetutorial.mailconnector.ra.outbound;
...
import javaeetutorial.mailconnector.api.JavaMailConnection;
import javaeetutorial.mailconnector.api.JavaMailConnectionFactory;
 ...
 * JavaBeans component.
 */
@ConnectionDefinition(connectionFactory = JavaMailConnectionFactory.class,
...
public class ManagedConnectionFactoryImpl implements
    ...
    static final Logger logger = 
            Logger.getLogger("javaeetutorial.mailconnector.ra.outbound");
    ...
    public Object createConnectionFactory(ConnectionManager cxManager)
        ...
        logger.info(" 2.- Outbound:ManagedConnectionFactoryImpl::createConnectionFactory(cxManager)");
    ...
    public Object createConnectionFactory()
            throws ResourceException {
        logger.info(" 2.- Outbound:ManagedConnectionFactoryImpl::createConnectionFactory()");
    ...
    public ManagedConnection createManagedConnection(Subject subject,
            ...
            throws ResourceException {
        logger.info(" 3A.- Outbound:ManagedConnectionFactoryImpl::createManagedConnection(Subject, cxM)");
        String name = null;
    ...
    public ManagedConnection matchManagedConnections(Set connectionSet,
            ...
            ConnectionRequestInfo cxRequestInfo)
            throws ResourceException {
        logger.info("[Outbound:ManagedConnectionFactoryImpl] Calling matchManagedConnections");
    ...
    public boolean equals(Object obj) {
        if (obj != null) {
            if (obj instanceof ManagedConnectionFactoryImpl) {
                ManagedConnectionFactoryImpl other =
    ...
    public void addPropertyChangeListener(PropertyChangeListener lis) {
        logger.info("[Outbound:ManagedConnectionFactoryImpl] Calling addPropertyChangeListener");
    ...
    public void removePropertyChangeListener(PropertyChangeListener lis) {
        logger.info("[Outbound:ManagedConnectionFactoryImpl] Calling removePropertyChangeListener");
        changes.removePropertyChangeListener(lis);
    }

    private void readObject(ObjectInputStream in)
            throws IOException, ClassNotFoundException {
        logger.info("[Outbound:ManagedConnectionFactoryImpl] Calling readobject");
    ...
    public String getServerName() {
        logger.info("[Outbound:ManagedConnectionFactoryImpl] Calling getServerName");
    ...
    public void setServerName(String serverName) {
        logger.info("[Outbound:ManagedConnectionFactoryImpl] Calling setServerName");
    ...
    public String getUserName() {
        logger.info("[Outbound:ManagedConnectionFactoryImpl] Calling getUserName");
    ...
    public void setUserName(String userName) {
        logger.info("[Outbound:ManagedConnectionFactoryImpl] Calling setUserName");
    ...
    public String getPassword() {
        logger.info("[Outbound:ManagedConnectionFactoryImpl] Calling getPassword");
    ...
    public void setPassword(String password) {
        logger.info("[Outbound:ManagedConnectionFactoryImpl] Calling setPassword");
    ...
    public String getFolderName() {
        logger.info("[Outbound:ManagedConnectionFactoryImpl] Calling getFolderName");
    ...
    public void setFolderName(String folderName) {
        logger.info("[Outbound:ManagedConnectionFactoryImpl] Calling setFolderName");
    ...
    public String getProtocol() {
        logger.info("[Outbound:ManagedConnectionFactoryImpl] Calling getProtocol");
     ...
     */
    @ConfigProperty(description = "Typically Imap",
    type = String.class,
    defaultValue = "Imap")
    public void setProtocol(String protocol) {
        logger.info("[Outbound:ManagedConnectionFactoryImpl] Calling setProtocol");
