...
public class Util {
    ...
    static public PasswordCredential getPasswordCredential(
        ...
        if (subject == null) {
            if (info == null) {
                logger.info("Outbound:Util::getPasswordCredential: INFO is null");
                return null;
            } else {
                ...
                if (myinfo.getUserName() == null || myinfo.getPassword() == null) {
                    logger.info("Outbound:Util::getPasswordCredential: User or password is null");
                    return null;
                }
                ...
                logger.info("Outbound:Util::getPasswordCredential: returning a created PC");
                return pc;
            }
        } else {
            PasswordCredential pc =
            ...
            if (pc == null) {
                ...
                logger.info("Outbound:Util::getPasswordCredential: returning a FOUND PC");
                return pc;
            }
        }
    }
