...
public class MailServerFolder {
    ...
    public MailServerFolder(ActivationSpecImpl spec)
        ...
        try {
            ...
            logger.warning("[Inbound:MailServerFolder::Constructor] Caught an exception when opening the folder");
            throw te;
        }
    }
    ...
    private void open()
        ...
        try {
            ...
            logger.info("[Inbound:MailServerFolder] Caught an exception when obtaining a "
                    + "JavaMail Session");
            throw te;
        }
