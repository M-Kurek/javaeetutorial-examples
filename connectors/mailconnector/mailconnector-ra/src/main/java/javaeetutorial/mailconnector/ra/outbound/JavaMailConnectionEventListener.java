...
public class JavaMailConnectionEventListener {
    ...
    public JavaMailConnectionEventListener(ManagedConnection mcon) {
        logger.info(" 3C.- Outbound:JavaMailConnectionEventListener::Constructor");
    ...
    public void sendEvent(int eventType, Exception ex,
        ...
        logger.info("[Outbound:JavaMailConnectionEventListener]: Calling sendEvent");
        ...
        for (int i = 0; i < list.size(); i++) {
            ConnectionEventListener l =
                    (ConnectionEventListener) list.get(i);
    ...
    public void addConnectorListener(ConnectionEventListener listener) {
        logger.info("[Outbound:JavaMailConnectionEventListener]: Calling addConnectorListener");
    ...
    public void removeConnectorListener(ConnectionEventListener listener) {
        logger.info("[Outbound:JavaMailConnectionEventListener]: Calling removeConnectorListener");
