...
public class JavaMailConnectionFactoryImpl implements
    ...
    public JavaMailConnection createConnection()
        ...
        logger.info(" 3.- Outbound:JavaMailConnectionFactoryImpl::createConnection -- Client requested a "
                + "connection. Get it from Connection Manager");

        // Use the default values of the managed connection factory

        JavaMailConnection con = (JavaMailConnection) cm.allocateConnection(mcf, null);

        logger.info(" 6.- Outbound:JavaMailConnectionFactoryImpl::createConnection -- Returning Connection to Client");
    ...
    public JavaMailConnection createConnection(ConnectionSpec properties)
        ...
        logger.info(" 6.- Outbound:JavaMailConnectionFactoryImpl::createConnection -- Returning Connection to user");
    ...
    public void setReference(Reference reference) {
        logger.info("[Outbound:JavaMailConnectionFactoryImpl] Calling setReference");
    ...
    public Reference getReference() {
        logger.info("[Outbound:JavaMailConnectionFactoryImpl] Calling getReference");
        return reference;
    }
}
