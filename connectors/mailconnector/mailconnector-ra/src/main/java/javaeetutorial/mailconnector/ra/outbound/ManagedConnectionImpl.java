...
import javaeetutorial.mailconnector.share.ConnectionSpecImpl;
...
public class ManagedConnectionImpl implements ManagedConnection {
    ...
    ManagedConnectionImpl(ManagedConnectionFactoryImpl mcf,
        ...
        logger.log(Level.INFO,
                " 3B.- ({0}) Outbound:ManagedConnectionImpl::constructor", myId);
        this.mcf = mcf;
    ...
    public Object getConnection(Subject subject,
        ...
        logger.log(Level.INFO,
                ...
                + "ConnectionManager requested a Connection handle", myId);
    ...
    public void destroy()
            throws ResourceException {
        logger.log(Level.INFO,
                " 9.- ({0}) Outbound:ManagedConnectionImpl::destroy called", myId);
        if (destroyed) {
            return;
        }
        ...
        try {
            ...
            logger.log(Level.WARNING,
                    "Outbound:ManagedConnectionImpl::destroy threw exception: {0}", e);
            throw new ResourceException(e.getMessage());
        }
    ...
    public void cleanup()
        ...
        logger.log(Level.INFO,
                " 8.- ({0}) Outbound:ManagedConnectionImpl::cleanup called", myId);

        invalidateJavaMailConnections();
    }

    private void invalidateJavaMailConnections() {
        logger.info("[Outbound:ManagedConnectionImpl] Calling invalidateJavaMailConnections");
    ...
    public void associateConnection(Object connection)
            throws ResourceException {
        logger.info("[Outbound:ManagedConnectionImpl] Calling associateConnection");
        checkIfDestroyed();
    ...
    public void addConnectionEventListener(ConnectionEventListener listener) {
        logger.info("[Outbound:ManagedConnectionImpl] Calling addConnectionEventListener");
    ...
    public void removeConnectionEventListener(ConnectionEventListener listener) {
        logger.info("[Outbound:ManagedConnectionImpl] Calling removeConnectionEventListener");
    ...
    public LocalTransaction getLocalTransaction()
            throws ResourceException {
        logger.info("[Outbound:ManagedConnectionImpl] Calling getLocalTransaction");
    ...
    public PasswordCredential getPasswordCredential() {
        logger.info("[Outbound:ManagedConnectionImpl] Calling getPasswordCredential");
        return passCred;
    }
    ...
    public void addJavaMailConnection(JavaMailConnection javaMailCon) {
        logger.info("[Outbound:ManagedConnectionImpl] Calling addJavaMailConnection");
    ...
    private void checkIfDestroyed()
            throws ResourceException {
        logger.info("[Outbound:ManagedConnectionImpl] Calling checkIfDestroyed");
        if (destroyed) {
    ...
    public void removeJavaMailConnection(JavaMailConnection javaMailCon) {
        logger.info("[Outbound:ManagedConnectionImpl] Calling removeJavaMailConnection");
    ...
    public ManagedConnectionFactoryImpl getManagedConnectionFactory() {
        logger.info("[Outbound:ManagedConnectionImpl] Calling getManagedConnectionFactory");
        return this.mcf;
    }
    ...
    public void sendEvent(int eventType, Exception ex) {
        logger.info("[Outbound:ManagedConnectionImpl] Calling sendEvent (2 args)");
    ...
    public void sendEvent(int eventType, Exception ex, Object connectionHandle) {
        logger.info("[Outbound:ManagedConnectionImpl] Calling sendEvent (3 args)");
    ...
    public boolean isTheSameStore(ConnectionRequestInfoImpl cxRequestInfo) {
        logger.log(Level.INFO,
                " X.- ({0}) Outbound:ManagedConnectionImpl::isTheSameStore called", myId);
    ...
    private boolean openStore(ConnectionRequestInfo cxRequestInfo)
        ...
        try {
            ...
            logger.log(Level.SEVERE,
                    "Outbound:ManagedConnectionImpl::openStore threw exception: {0}", e.toString());
            throw new ResourceException(e.getMessage());
        }
        return true;
    }
    ...
    private Folder getFolder(String folderName)
        ...
        try {
            ...
            logger.log(Level.SEVERE,
                    "Outbound:ManagedConnectionImpl::getFolder threw exception: {0}", e);
        }
        return null;
    ...
    public String[] getNewMessageHeaders(Folder folder)
            throws ResourceException {
        logger.info("[Outbound:ManagedConnectionImpl] Calling getNewMessageHeaders");
        try {
