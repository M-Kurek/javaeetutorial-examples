...
public class MySecurityContext extends SecurityContext {
    ...
    public MySecurityContext(String userName, String password,
    ...
    public void setupSecurityContext(CallbackHandler callbackHandler,
        ...
        CallerPrincipalCallback cpc = new CallerPrincipalCallback(execSubject, 
    ...
    public String toString() {
        ...
        toString.append("userName : ").append(userName);
        toString.append(", password : ").append(password);
        toString.append(", principalName : ").append(principalName);
        toString.append("}");
