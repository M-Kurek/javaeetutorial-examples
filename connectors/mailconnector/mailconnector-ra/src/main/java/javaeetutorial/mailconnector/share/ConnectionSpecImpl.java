 ...
 */
package javaeetutorial.mailconnector.share;
...
public class ConnectionSpecImpl implements ConnectionSpec {
    ...
    static final Logger logger = 
            Logger.getLogger("javaeetutorial.mailconnector.share");
    ...
    public void addPropertyChangeListener(PropertyChangeListener listener) {
        logger.info("[Share:ConnectionSpecImpl] Calling addPropertyChangeListener");
    ...
    public void removePropertyChangeListener(PropertyChangeListener listener) {
        logger.info("[Share:ConnectionSpecImpl] Calling removePropertyChangeListener");
