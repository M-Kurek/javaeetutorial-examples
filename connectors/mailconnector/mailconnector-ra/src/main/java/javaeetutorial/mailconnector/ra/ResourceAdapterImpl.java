 ...
 */
package javaeetutorial.mailconnector.ra;
...
import javaeetutorial.mailconnector.ra.inbound.ActivationSpecImpl;
import javaeetutorial.mailconnector.ra.inbound.EndpointConsumer;
import javaeetutorial.mailconnector.ra.inbound.PollingThread;
...
public class ResourceAdapterImpl
    ...
    static final Logger logger = 
            Logger.getLogger("javaeetutorial.mailconnector.ra");
    ...
    public void start(BootstrapContext ctx)
        ...
        try {
            ...
            throw new ResourceAdapterInternalException(
                    MessageFormat.format(resource.getString(
    ...
    public void endpointActivation(MessageEndpointFactory endpointFactory,
        ...
        try {
            ...
            ((PollingThread) pollingThread).addEndpointConsumer(endpointFactory,
                    ec);
        } catch (Exception ex) {
