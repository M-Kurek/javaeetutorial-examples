...
public class PublisherBean implements PublisherRemote {
    ...
    /**
     * Creates producer and message. Sends messages after setting their
     * NewsType property and using the property value as the message text.
     * Messages are received by MessageBean, a message-driven bean that uses a
     * message selector to retrieve messages whose NewsType property has certain
     * values.
     */
    @Override
